...
class RobustWarpSupOp : public OpKernel {
 public:
  explicit RobustWarpSupOp(OpKernelConstruction* context) : OpKernel(context) {}
...
// register the kernel
REGISTER_KERNEL_BUILDER(Name("RobustWarpSup").Device(DEVICE_CPU), RobustWarpSupOp);